...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.get('/check',
            ...
            function ServerCheckController_getAppCheck(request: any, response: any, next: any) {
            const args = {
            ...
            try {
                ...
                const controller = new ServerCheckController();


              const promise = controller.getAppCheck.apply(controller, validatedArgs as any);
